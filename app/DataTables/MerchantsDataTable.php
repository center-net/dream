...
class MerchantsDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.merchants.buttons.actions')
    ...
    {
        return Merchant::query()->with(['category_id',])->select("merchants.*");
    	...
    	public function html()
	    {
	      $html =  $this->builder()
            ...
            ". filterElement('1,2,3', 'input') . "
                        ...
                        //category_idmrchant_name,mobile,category_id,status4
            ". filterElement('4', 'select', \App\Models\Category::pluck("category_name","category_name")) . "
            //statusmrchant_name,mobile,category_id,status5
 ...
 [
				...
				[
                 'name'=>'mrchant_name',
                 'data'=>'mrchant_name',
                 'title'=>trans('admin.mrchant_name'),
		    ],
				[
                 'name'=>'mobile',
                 'data'=>'mobile',
