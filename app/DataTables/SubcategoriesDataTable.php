...
class SubcategoriesDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.subcategories.buttons.actions')
    ...
    {
        return Subcategory::query()->with(['category_id',])->select("subcategories.*");
    	...
    	public function html()
	    {
	      $html =  $this->builder()
            ...
            ". filterElement('1,2', 'input') . "
                        ...
                        //category_idcategory_name,category_id,status3
            ". filterElement('3', 'select', \App\Models\Category::pluck("category_name","category_name")) . "
            //statuscategory_name,category_id,status4
