...
class StreetsDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.streets.buttons.actions')
    ...
    {
        return Street::query()->with(['region_id',])->select("streets.*");
    	...
    	public function html()
	    {
	      $html =  $this->builder()
            ...
            ". filterElement('1,2', 'input') . "
                        ...
                        //region_idstreetName,region_id3
            ". filterElement('3', 'select', \App\Models\Region::pluck("regionsName","regionsName")) . "
