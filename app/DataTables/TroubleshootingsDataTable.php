...
class TroubleshootingsDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.troubleshootings.buttons.actions')
    ...
    {
        return Troubleshooting::query()->with(['ticket_id','action_id',])->select("troubleshootings.*");
...
[
				...
				[
                 'name'=>'ticket_id.id',
                 'data'=>'ticket_id.id',
                 'title'=>trans('admin.ticket_id'),
		    ],
				[
                 'name'=>'diagnosis',
                 'data'=>'diagnosis',
                 'title'=>trans('admin.diagnosis'),
		    ],
				[
                 'name'=>'action_id.name_actions',
                 'data'=>'action_id.name_actions',
                 'title'=>trans('admin.action_id'),
		    ],
 ];
			}
