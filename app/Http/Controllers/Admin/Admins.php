...
class Admins extends Controller {
	...
	public function store(AdminsRequest $request) {
		...
		$addAdmin = Admin::create($data);
		if($addAdmin){
		    $salarie['admin_id'] = $addAdmin->id;
		    Salarie::create($salarie);
		}
    ...
    public function profile() {
        $admins = Admin::find(admin()->user()->id);
		return is_null($admins) || empty($admins) ?
		backWithError(trans("admin.undefinedRecord")) :
		view('admin.admins.Profile', [
    ...
    public function editprofile() {
		...
		return is_null($admins) || empty($admins) ?
		backWithError(trans("admin.undefinedRecord")) :
		view('admin.admins.EditProfile', [
			'title' => trans('admin.EditProfile'),
			'admins' => $admins,
        ]);
	}
	/**
	...
	public function update(AdminsRequest $request, $id) {
		...
		return redirectWithSuccess(aurl('/'), trans('admin.updated'));
	}
	...
	public function destroy($id) {
		$admins = Admin::find($id);
		$salarie = Salarie::where('admin_id',$id)->first();
		$advances = Advance::where('admin_id',$id)->get();
