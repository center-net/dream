 ...
 <div class="btn-group">
	...
	<div class="dropdown-menu" role="menu">
		<a href="<?php echo e(aurl('/purchases/'.$id.'/edit')); ?>" class="dropdown-item" ><i class="fas fa-edit"></i> <?php echo e(trans('admin.edit')); ?></a>
		<a href="<?php echo e(aurl('/purchases/'.$id)); ?>" class="dropdown-item" ><i class="fa fa-eye"></i> <?php echo e(trans('admin.show')); ?></a>
...
<div class="modal fade" id="delete_record<?php echo e($id); ?>">
	<div class="modal-dialog">
		...
		<?php /**PATH /home/helplgvr/public_html/dream/resources/views/admin/purchases/buttons/actions.blade.php ENDPATH**/ ?>