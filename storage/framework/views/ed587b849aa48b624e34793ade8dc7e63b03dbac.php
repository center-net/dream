 ...
 <div class="btn-group">
	...
	<div class="dropdown-menu" role="menu">
		<a href="<?php echo e(aurl('/troubleshootings/'.$id.'/edit')); ?>" class="dropdown-item" ><i class="fas fa-edit"></i> <?php echo e(trans('admin.edit')); ?></a>
		<a href="<?php echo e(aurl('/troubleshootings/'.$id)); ?>" class="dropdown-item" ><i class="fa fa-eye"></i> <?php echo e(trans('admin.show')); ?></a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<?php echo Form::open([
				'method' => 'DELETE',
				'route' => ['troubleshootings.destroy', $id]
				]); ?>
		...
		<?php /**PATH /home/helplgvr/public_html/dream/resources/views/admin/troubleshootings/buttons/actions.blade.php ENDPATH**/ ?>