...
<li class="nav-item <?php echo e(active_link('categories','menu-open')); ?> ">
  <a href="#" class="nav-link <?php echo e(active_link('categories','active')); ?>">
    <i class="nav-icon fa fa-icons"></i>
    <p>
  ...
  <ul class="nav nav-treeview">
    ...
    <li class="nav-item">
      <a href="<?php echo e(aurl('categories/create')); ?>" class="nav-link">
        <i class="fas fa-plus nav-icon"></i>
        <p><?php echo e(trans('admin.create')); ?> </p>
      </a>
    </li>
