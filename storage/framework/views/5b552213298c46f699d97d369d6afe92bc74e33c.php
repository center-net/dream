<div class="btn-group">
	...
	<div class="dropdown-menu" role="menu">
		<a href="<?php echo e(aurl('/admingroups/'.$id.'/edit')); ?>" class="dropdown-item" ><i class="fas fa-edit"></i> <?php echo e(trans('admin.edit')); ?></a>
		<a href="<?php echo e(aurl('/admingroups/'.$id)); ?>" class="dropdown-item" ><i class="fa fa-eye"></i> <?php echo e(trans('admin.show')); ?></a>
...
</div><?php /**PATH /home/helplgvr/public_html/dream/resources/views/admin/admingroups/buttons/actions.blade.php ENDPATH**/ ?>