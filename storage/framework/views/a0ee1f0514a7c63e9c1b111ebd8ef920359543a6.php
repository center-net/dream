...
<?php echo Form::open(["method" => "post","url" => [aurl('/admingroups/multi_delete')]]); ?>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<?php echo Form::submit(trans("admin.approval"), ["class" => "btn btn-danger delete_done"]); ?>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/helplgvr/public_html/dream/resources/views/admin/admingroups/index.blade.php ENDPATH**/ ?>