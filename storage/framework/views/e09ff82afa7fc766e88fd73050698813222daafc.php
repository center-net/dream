<div class="col-md-12 well">
  <div class="col-md-3">
    <div class="form-group">
      ...
      <div class="col-md-12">
        <input type="text" name="col_name[]" value="<?php echo e(old('col_name')); ?>" class="form-control col_name" placeholder="<?php echo e(it_trans('it.col_name')); ?>"  />
      </div>
    </div>
  </div>
  <div class="col-md-4">
    <div class="form-group" style="margin-top: -16px;">
      ...
      <div class="col-md-12">
        <select name="col_type[]" class="form-control">
          <option value="text"><?php echo e(it_trans('it.text')); ?></option>
          <option value="number"><?php echo e(it_trans('it.number')); ?></option>
          <option value="email"><?php echo e(it_trans('it.email')); ?></option>
          <option value="url"><?php echo e(it_trans('it.url')); ?></option>
          <option value="textarea"><?php echo e(it_trans('it.textarea')); ?></option>
          <option value="textarea_ckeditor"><?php echo e(it_trans('it.textarea_ckeditor')); ?></option>
          <option value="select"><?php echo e(it_trans('it.select')); ?></option>
          <option value="file"><?php echo e(it_trans('it.file')); ?></option>
          <option value="dropzone"><?php echo e(it_trans('it.dropzone')); ?></option>
          <option value="password"><?php echo e(it_trans('it.password')); ?></option>
          <option value="checkbox"><?php echo e(it_trans('it.checkbox')); ?></option>
          <option value="radio"><?php echo e(it_trans('it.radio')); ?></option>
          <option value="date"><?php echo e(it_trans('it.date')); ?></option>
          <option value="date_time"><?php echo e(it_trans('it.date_time')); ?></option>
          <option value="time"><?php echo e(it_trans('it.time')); ?></option>
          <option value="timestamp"><?php echo e(it_trans('it.timestamp')); ?></option>
          <option value="color"><?php echo e(it_trans('it.color')); ?></option>
        </select>
      </div>
    </div>
    <div class="form-group">
  ...
  <div class="col-md-5">
    <div class="form-group">
      <div class="col-md-12">
        ...
        <input type="text" name="col_name_convention[]"  to="0" value="<?php echo e(old('col_name_convention')); ?>" class="form-control col_name_convention" placeholder="<?php echo e(it_trans('it.col_name_convention')); ?>"  />
      ...
      <div class="forginkeyto0 hidden">
        <div class="form-group col-md-4">
          <label class="form-check-input" dir="rtl"> <?php echo e(it_trans('it.references')); ?>
            ...
            <input type="text" name="references0" placeholder="<?php echo e(it_trans('it.references')); ?>" class="form-control references" to="0" value="id" />
          </div>
          <div class="form-group col-md-4">
            <label class="form-check-input" dir="rtl"> <?php echo e(it_trans('it.forgin_table_name')); ?>

              <input type="text" name="forgin_table_name0" placeholder="<?php echo e(it_trans('it.forgin_table_name')); ?>" class="form-control forgin_table_name"  to="0" />
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label class="form-check-input" dir="rtl"> <?php echo e(it_trans('it.nullable')); ?>
        ...
        </div><?php /**PATH /home/helplgvr/public_html/dream/vendor/phpanonymous/it/it/views/baboon/new_input_add.blade.php ENDPATH**/ ?>