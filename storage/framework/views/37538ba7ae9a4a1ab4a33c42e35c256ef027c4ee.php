...
<?php if(admin()->user()->id == $admins->id): ?>
  ...
  <div class="card-header">
    ...
    <div class="">
      ...
      <div class="dropdown-menu" role="menu">
        ...
        <a class="dropdown-item" style="color:#343a40" href="<?php echo e(aurl('/editprofile/'.admin()->user()->id)); ?>">
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/helplgvr/public_html/dream/resources/views/admin/admins/Profile.blade.php ENDPATH**/ ?>