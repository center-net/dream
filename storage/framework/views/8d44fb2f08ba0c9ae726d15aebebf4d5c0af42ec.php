...
<?php if(admin()->user()->role("settings_show")): ?>
    <li class="nav-item <?php echo e(active_link('admins','menu-open')); ?>">
        ...
        <!--streets_end_route-->
            ...
            <?php endif; ?>
            <?php if(admin()->user()->role("routers_show")): ?>
                <li class="nav-item">
                    <a href="<?php echo e(aurl('routers')); ?>" class="nav-link  <?php echo e(active_link('routers','active')); ?>">
                        <i class="fa fa-icons nav-icon"></i>
                        <p><?php echo e(trans('admin.routers')); ?> </p>
                    </a>
                </li>
            <?php endif; ?>
        <!--categories_start_route-->
            <?php if(admin()->user()->role("categories_show")): ?>
                <li class="nav-item">
                    <a href="<?php echo e(aurl('categories')); ?>" class="nav-link  <?php echo e(active_link('categories','active')); ?>">
                        <i class="fa fa-icons nav-icon"></i>
        ...
        <!--categories_end_route-->
            ...
            <?php if(admin()->user()->role("subcategories_show")): ?>
                <li class="nav-item">
                    <a href="<?php echo e(aurl('subcategories')); ?>" class="nav-link  <?php echo e(active_link('subcategories','active')); ?>">
                        <i class="fa fa-icons nav-icon"></i>
                        <p><?php echo e(trans('admin.subcategories')); ?> </p>
                    </a>
                </li>
            <?php endif; ?>
        <!--subcategories_end_route-->
            <!--merchants_start_route-->
            <?php if(admin()->user()->role("merchants_show")): ?>
                <li class="nav-item">
                    <a href="<?php echo e(aurl('merchants')); ?>" class="nav-link  <?php echo e(active_link('merchants','active')); ?>">
                        <i class="fa fa-icons nav-icon"></i>
                        <p><?php echo e(trans('admin.merchants')); ?> </p>
                    </a>
                </li>
        <?php endif; ?>
        <!--merchants_end_route-->
...
<?php /**PATH E:\xampp\htdocs\dream\resources\views/admin/layouts/menu.blade.php ENDPATH**/ ?>