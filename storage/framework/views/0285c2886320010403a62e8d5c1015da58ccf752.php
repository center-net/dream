        ...
        <div class="tabbable" id="tabs-442449">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="All_Routes">
                    <?php echo it_views('route',['name'=>'All Routes','routes'=>$all]); ?>

                </div>
                <div class="tab-pane" id="GET_Routes">
                    <?php echo it_views('route',['name'=>'GET Routes','routes'=>$all,'in'=>'GET']); ?>

                </div>
                <div class="tab-pane" id="HEAD_Routes">
                    <?php echo it_views('route',['name'=>'HEAD Routes','routes'=>$all,'in'=>'HEAD']); ?>

                </div>
                <div class="tab-pane" id="POST_Routes">
                    <?php echo it_views('route',['name'=>'POST Routes','routes'=>$all,'in'=>'POST']); ?>

                </div>
                <div class="tab-pane" id="PUT_Routes">
                    <?php echo it_views('route',['name'=>'PUT Routes','routes'=>$all,'in'=>'PUT']); ?>

                </div>
                <div class="tab-pane" id="PATCH_Routes">
                    <?php echo it_views('route',['name'=>'PATCH Routes','routes'=>$all,'in'=>'PATCH']); ?>

                </div>
                <div class="tab-pane" id="DELETE_Routes">
                    <?php echo it_views('route',['name'=>'DELETE Routes','routes'=>$all,'in'=>'DELETE']); ?>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/helplgvr/public_html/dream/vendor/phpanonymous/it/it/views/routelist.blade.php ENDPATH**/ ?>