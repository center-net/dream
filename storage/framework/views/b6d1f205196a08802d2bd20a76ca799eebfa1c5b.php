...
function showLink(checkbox_val,type,method,controller_name,url=''){
	var url_data = "<?php echo e(url('api/v1')); ?>/"+controller_name+url;
...
<div class="col-md-12 col-lg-12 col-xs-12">
	<center><h1><?php echo e(it_trans('it.api_settings')); ?></h1></center>
	<div class="col-md-4">
		<h4>Show Columns</h4>
	...
	<div class="col-md-2">
		...
		<ol>
		  <li>
		  	<label>
		  		<input type="checkbox" class="api_url" <?php echo e(api_check('api_index')); ?> name="api_url[]" value="api_index">
		  		Index
		  	</label>
		  </li>
		  <li>
		  	<label>
		  		<input type="checkbox" class="api_url" <?php echo e(api_check('api_show')); ?> name="api_url[]"  value="api_show">
		  		Show
		  	</label>
		  </li>
		  <li>
		  	<label>
		  		<input type="checkbox" class="api_url"  <?php echo e(api_check('api_create')); ?> name="api_url[]" value="api_create">
		  		Create
		  	</label>
		  </li>
		  <li>
		  	<label>
		  		<input type="checkbox" class="api_url" <?php echo e(api_check('api_update')); ?> name="api_url[]" value="api_update">
		  		Update
		  	</label>
		  </li>
		  <li>
		  	<label>
		  		<input type="checkbox" class="api_url" <?php echo e(api_check('api_delete')); ?> name="api_url[]" value="api_delete">
		  		Delete
		  	</label>
		  </li>
		  <li>
		  	<label>
		  		<input type="checkbox" class="api_url" <?php echo e(api_check('api_multi_delete')); ?> name="api_url[]" value="api_multi_delete">
		  		Multi Delete
		  	</label>
		  </li>
		</ol>
	</div>
</div><?php /**PATH /home/helplgvr/public_html/dream/vendor/phpanonymous/it/it/views/baboon/api_settings.blade.php ENDPATH**/ ?>