<!--<?php echo e($link); ?>_start-->
<?php if($default_theme == 'small-box'): ?>
<?php
...
';
?>
<?php elseif($default_theme == 'info-box'): ?>
<?php
...
';
?>
<?php elseif($default_theme == 'progress-box'): ?>
<?php
echo '<div class="col-md-3 col-sm-6 col-12">
...
?>
<?php endif; ?>
<!--<?php echo e($link); ?>_end--><?php /**PATH /home/helplgvr/public_html/dream/vendor/phpanonymous/it/it/views/baboon/elements/statistics/make_counter.blade.php ENDPATH**/ ?>