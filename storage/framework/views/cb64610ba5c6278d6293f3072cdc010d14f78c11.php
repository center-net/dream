  ...
  <div class="col-md-5">
    <div class="form-group">
      <div class="col-md-12">
        ...
        <input type="text" name="col_name_convention[]"  to="`+x+`" value="<?php echo e(old('col_name_convention')); ?>" class="form-control col_name_convention" placeholder="<?php echo e(it_trans('it.col_name_convention')); ?>"  />
      ...
      <div class="forginkeyto`+x+` hidden">
        <div class="form-group col-md-4">
          <label class="form-check-input" dir="rtl"> <?php echo e(it_trans('it.references')); ?>
            ...
            <input type="text" name="references`+x+`" placeholder="<?php echo e(it_trans('it.references')); ?>" class="form-control references" to="`+x+`" />
          </div>
          <div class="form-group col-md-4">
            <label class="form-check-input" dir="rtl"> <?php echo e(it_trans('it.forgin_table_name')); ?>

              <input type="text" name="forgin_table_name`+x+`" placeholder="<?php echo e(it_trans('it.forgin_table_name')); ?>" class="form-control forgin_table_name"  to="`+x+`" />
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label class="form-check-input" dir="rtl"> <?php echo e(it_trans('it.nullable')); ?>
          ...
          `<?php /**PATH /home/helplgvr/public_html/dream/vendor/phpanonymous/it/it/views/baboon/new_input.blade.php ENDPATH**/ ?>