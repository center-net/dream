	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a href="<?php echo e(aurl('purchases/'.$purchases->id)); ?>" class="dropdown-item" style="color:#343a40">
...
<?php echo Form::open(['url'=>aurl('/purchases/'.$purchases->id),'method'=>'put','id'=>'purchases','files'=>true,'class'=>'form-horizontal form-row-seperated']); ?>
...
<?php echo Form::select('status',['yes'=>'موافقة','no'=>'رفض'], $purchases->status ,['class'=>'form-control select2','placeholder'=>trans('admin.status')]); ?>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/helplgvr/public_html/dream/resources/views/admin/purchases/edit.blade.php ENDPATH**/ ?>