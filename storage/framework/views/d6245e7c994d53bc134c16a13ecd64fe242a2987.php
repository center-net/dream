...
<div class="panel panel-default">
    <div class="bs-callout bs-right-panel">
        ...
        <div class="row">
            <br/>
            <p class="text-center">Copyright Reserved <a href="https://it.phpanonymous.com">it</a> &copy; <?php echo e(date('Y')); ?>

            IT Package <?php echo e(it_trans('it.version')); ?><?php echo e(it_version()); ?> ,
            <a href="#" data-toggle="modal" data-target="#partners" title="partners">
                <i class="fa fa-users"></i> <?php echo e(it_trans('it.partners')); ?>
...
<?php echo $__env->yieldPushContent('baboon_js'); ?>
</body>
</html><?php /**PATH /home/helplgvr/public_html/dream/vendor/phpanonymous/it/it/views/layouts/footer.blade.php ENDPATH**/ ?>