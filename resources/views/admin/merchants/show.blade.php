	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a class="dropdown-item"  style="color:#343a40" href="{{aurl('merchants/'.$merchants->id.'/edit')}}">
	...
	<div class="card-body">
		<div class="row">
			<div class="col-md-12 col-lg-12 col-xs-12">
				<b>{{trans('admin.id')}} :</b> {{$merchants->id}}
			</div>
			<div class="clearfix"></div>
			<hr />
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
				<b>{{trans('admin.mrchant_name')}} :</b>
				{!! $merchants->mrchant_name !!}
			</div>
				...
				@if(!empty($merchants->category_id()->first()))
			{{ $merchants->category_id()->first()->category_name }}
			@endif
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
				<b>{{trans('admin.status')}} :</b>
				{{ trans("admin.".$merchants->status) }}
			</div>
