	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a href="{{aurl('subcategories/'.$subcategories->id)}}" class="dropdown-item" style="color:#343a40">
...
{!! Form::open(['url'=>aurl('/subcategories/'.$subcategories->id),'method'=>'put','id'=>'subcategories','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="row">

<div class="col-md-4 col-lg-4 col-sm-4 col-xs-6">
    <div class="form-group">
        {!! Form::label('category_name',trans('admin.category_name'),['class'=>'control-label']) !!}
        {!! Form::text('category_name', $subcategories->category_name ,['class'=>'form-control','placeholder'=>trans('admin.category_name')]) !!}
    </div>
</div>
<div class="col-md-4 col-lg-4 col-sm-4 col-xs-6">
		<div class="form-group">
				{!! Form::label('category_id',trans('admin.category_id'),['class'=>'control-label']) !!}
{!! Form::select('category_id',App\Models\Category::pluck('category_name','id'), $subcategories->category_id ,['class'=>'form-control select2','placeholder'=>trans('admin.category_id')]) !!}
		</div>
</div>
<div class="col-md-4 col-lg-4 col-sm-4 col-xs-6">
		<div class="form-group">
				{!! Form::label('status',trans('admin.status'),['class'=>'control-label']) !!}
{!! Form::select('status',['yes'=>trans('admin.yes'),'no'=>trans('admin.no'),], $subcategories->status ,['class'=>'form-control select2','placeholder'=>trans('admin.status')]) !!}
		</div>
</div>
