...
@if (admin()->user()->id == $admins->id)
  ...
  <div class="card-header">
    ...
    <div class="">
      ...
      <div class="dropdown-menu" role="menu">
        ...
        <a class="dropdown-item" style="color:#343a40" href="{{ aurl('/editprofile/'.admin()->user()->id)}}">
  ...
  <div class="card-footer">
      {{-- {{Carbon::now()->diffInYears($admins->created_at->copy()->addYear())}} --}}
      {{-- {{$admins->created_at.'============='}} --}}
      {{-- {{ Carbon::parse($admins->created_at)->addWeeks(1);}} --}}

</br>
{{-- {{$now = Carbon::now()->startOfWeek(Carbon::SATURDAY)->addWeeks(1);}} --}}
