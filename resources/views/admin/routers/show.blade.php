	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a class="dropdown-item"  style="color:#343a40" href="{{aurl('routers/'.$routers->id.'/edit')}}">
	...
	<div class="card-body">
		<div class="row">
			<div class="col-md-12 col-lg-12 col-xs-12">
				<b>{{trans('admin.id')}} :</b> {{$routers->id}}
			</div>
			<div class="clearfix"></div>
			<hr />
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
				<b>{{trans('admin.router_number')}} :</b>
				{!! $routers->router_number !!}
			</div>
				...
				<b>{{trans('admin.ip_router')}} :</b>
				{!! $routers->ip_router !!}
			</div>
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-4">
				<b>{{trans('admin.region_id')}} :</b>
				@if(!empty($routers->region_id()->first()))
			{{ $routers->region_id()->first()->regionsName }}
			@endif
			</div>
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-4">
				<b>{{trans('admin.street_id')}} :</b>
				@if(!empty($routers->street_id()->first()))
			{{ $routers->street_id()->first()->streetName }}
			@endif
			</div>
