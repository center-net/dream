...
{{ !empty(setting()->theme_setting) &&
   !empty(setting()->theme_setting->main_header)?
    ...
    <ul class="navbar-nav mr-auto-navbav">
        <li class="nav-item d-none d-sm-inline-block">
         <span class="nav-link">   اليوم : {{Carbon::today()->isoFormat('dddd')}} {{Carbon::today()->format('Y-m-d')}}</span>
        </li>
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
                {{ admin()->user()->first_name }} {{ admin()->user()->last_name }}
            </a>
            <div class="dropdown-menu dropdown-menu-lg messages  {{ app('l') == 'ar'?'dropdown-menu-right':'dropdown-menu-left' }}" style=" width: 155px;">
                <a href="#" class="dropdown-item" data-toggle="modal" data-target="#addAdvance" data-whatever="{{admin()->user()->id}}">
                    <!-- Message Start -->
                    <div class="media">
          ...
          <div class="dropdown-divider"></div>
                <a href="{{ aurl('/profile')}}" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                      <div class="media-body">
                        <h3 class="dropdown-item-title text-center">
              ...
              <div class="dropdown-divider"></div>
              <a href="{{ aurl('/editprofile')}}" class="dropdown-item">
                <!-- Message Start -->
                <div class="media">
                  <div class="media-body">
                    <h3 class="dropdown-item-title text-center">
