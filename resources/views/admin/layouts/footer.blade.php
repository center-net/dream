	...
	<div class="modal-dialog ">
		<div class="modal-content">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            {!! Form::label('advance',trans('admin.advance'),['class'=>' control-label']) !!}
                                {!! Form::text('advance',old('advance'),['class'=>'form-control','placeholder'=>trans('admin.advance')]) !!}
                        </div>
                    </div>
			...
			<div class="modal-footer">
                <div class="card-footer"><button type="submit" name="add" class="btn btn-primary btn-flat"> {{ trans('admin.add') }}</button>
